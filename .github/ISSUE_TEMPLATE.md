...
about: Report an issue related to the Open Peer Power frontend.
labels: bug
---

<!-- READ THIS FIRST:
- If you need additional help with this template please refer to https://www.openpeerpower.io/help/reporting_issues/
- Make sure you are running the latest version of Open Peer Power before reporting an issue: https://github.com/openpeerpower/openpeerpower/releases
...
- [ ] I have updated to the latest available Open Peer Power version.
...
<!--
  ...
  Open Peer Power frontend: Configuration -> Info.

  Browser version and operating system is important! Please try to replicate
  your issue in a different browser and be sure to include your findings.
-->

- Open Peer Power release with the issue:
