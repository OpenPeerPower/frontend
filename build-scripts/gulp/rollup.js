...
gulp.task("rollup-watch-oppio", () => {
  watchRollup(rollupConfig.createOppioConfig, ["oppio/src/**"]);
});
...
gulp.task("rollup-prod-oppio", () =>
  bothBuilds(rollupConfig.createOppioConfig, { isProdBuild: true })
);
