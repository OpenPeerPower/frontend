...
const showMediaPlayer = () => {
  ...
  if (!playerStylesAdded) {
    ...
    style.innerHTML = `
    body {
      --logo-image: url('https://www.openpeerpower.io/images/openpeerpower-logo.svg');
      --logo-repeat: no-repeat;
      --playback-logo-image: url('https://www.openpeerpower.io/images/openpeerpower-logo.svg');
      --theme-hue: 200;
      --progress-color: #03a9f4;
      --splash-image: url('https://openpeerpower.io/images/cast/splash.png');
      --splash-size: cover;
    }
    `;
