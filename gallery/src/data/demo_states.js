export default {
  ...
  "persistent_notification.notification": {
    ...
    attributes: {
      title: "Welcome Home!",
      message:
        "Here are some resources to get started:\n\n - [Configuring Open Peer Power](https://openpeerpower.io/getting-started/configuration/)\n - [Available integrations](https://openpeerpower.io/integrations/)\n - [Troubleshooting your configuration](https://openpeerpower.io/docs/configuration/troubleshooting/)\n - [Getting help](https://openpeerpower.io/help/)\n\nTo not see this card popup in the future, edit your config in\n`configuration.yaml` and disable the `introduction` integration.",
    },
