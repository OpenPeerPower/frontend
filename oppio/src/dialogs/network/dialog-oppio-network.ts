...
import { OppioNetworkDialogParams } from "./show-dialog-network";

const IP_VERSIONS = ["ipv4", "ipv6"];

@customElement("dialog-oppio-network")
export class DialogOppioNetwork extends LitElement
  implements OppDialog<OppioNetworkDialogParams> {
  ...
  @internalProperty() private _params?: OppioNetworkDialogParams;
  ...
  public async showDialog(params: OppioNetworkDialogParams): Promise<void> {
    this._params = params;
    this._dirty = false;
    this._curTabIndex = 0;
...
declare global {
  interface HTMLElementTagNameMap {
    "dialog-oppio-network": DialogOppioNetwork;
  }
}
