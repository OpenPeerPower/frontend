  ...
  private _generateData() {
    ...
    deviceStates.forEach((states) => {
      ...
      if (
        ...
        addDataSet(
          `${this.opp.localize("ui.card.climate.current_temperature", {
            name: name,
          })}`,
          true
        );
        ...
        if (hasTargetRange) {
          addDataSet(
            `${this.opp.localize("ui.card.climate.target_temperature_mode", {
              name: name,
              mode: this.opp.localize("ui.card.climate.high"),
            })}`,
            true
          );
          addDataSet(
            `${this.opp.localize("ui.card.climate.target_temperature_mode", {
              name: name,
              mode: this.opp.localize("ui.card.climate.low"),
            })}`,
            true
          );
        } else {
          addDataSet(
            `${this.opp.localize("ui.card.climate.target_temperature_entity", {
              name: name,
            })}`,
            true
          );
        ...
        addDataSet(
          `${this.opp.localize("ui.card.humidifier.target_humidity_entity", {
            name: name,
          })}`,
          true
        );
        addDataSet(
          `${this.opp.localize("ui.card.humidifier.on_entity", {
            name: name,
          })}`,
          true,
          true
