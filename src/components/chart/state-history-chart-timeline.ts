...
const invertOnOff = (entityState?: OppEntity) =>
  entityState &&
      ...
      this._chartOptions = {
        ...
        scales: {
          ...
          y: {
            ...
            position: computeRTL(this.opp) ? "right" : "left",
          },
        },
        plugins: {
          tooltip: {
            ...
            callbacks: {
              ...
              label: (item) => {
                ...
                return [
                  d.label || "",
                  formatDateTimeWithSeconds(d.start, this.opp.locale),
                  formatDateTimeWithSeconds(d.end, this.opp.locale),
                ];
              },
              labelColor: (item) => ({
      ...
      stateInfo.data.forEach((entityState) => {
        ...
        if (prevState === null) {
          ...
          dataRow.push({
            ...
            color: getColor(
              prevState,
              this.opp.states[stateInfo.entity_id],
              computedStyles
            ),
          });
