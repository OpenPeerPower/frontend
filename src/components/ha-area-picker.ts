    ...
    (
      ...
      if (!areas.length) {
        return [
          {
            area_id: "",
            name: this.opp.localize("ui.components.area-picker.no_areas"),
          },
        ];
      }
      ...
      if (!outputAreas.length) {
        outputAreas = [
          {
            area_id: "",
            name: this.opp.localize("ui.components.area-picker.no_match"),
          },
        ];
      }
    ...
    return html`
      ...
      >
        ...
        >
          ...
          <mwc-icon-button
            .label=${this.opp.localize("ui.components.area-picker.toggle")}
            slot="suffix"
            class="toggle-button"
          >
            <ha-svg-icon
