...
import { Context, OpenPeerPower } from "../types";
...
export interface OppTrigger extends BaseTrigger {
...
export const getAutomationConfig = (opp: OpenPeerPower, id: string) =>
  opp.callApi<AutomationConfig>("GET", `config/automation/config/${id}`);
...
export const subscribeTrigger = (
  ...
  opp.connection.subscribeMessage(onChange, {
