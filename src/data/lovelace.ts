...
type LovelaceUpdatedEvent = OppEventBase & {
...
export const deleteResource = (opp: OpenPeerPower, id: string) =>
  opp.callWS({
...
export const deleteDashboard = (opp: OpenPeerPower, id: string) =>
  opp.callWS({
