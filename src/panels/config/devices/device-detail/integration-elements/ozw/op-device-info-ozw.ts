...
export class HaDeviceInfoOzw extends LitElement {
  ...
  protected render(): TemplateResult {
    ...
    return html`
      <h4>
        ${this.opp.localize("ui.panel.config.ozw.device_info.zwave_info")}
      </h4>
      <div>
      ...
      <div>
        ${this.opp.localize("ui.panel.config.ozw.device_info.stage")}:
      ...
      <div>
        ${this.opp.localize("ui.panel.config.ozw.device_info.node_failed")}:
