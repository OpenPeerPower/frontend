...
@customElement("op-device-info-zha")
  ...
  protected render(): TemplateResult {
    ...
    return html`
      ...
      <div>
        LQI:
        ${this._zhaDevice.lqi ||
        this.opp!.localize("ui.dialogs.zha_device_info.unknown")}
      </div>
      <div>
        RSSI:
      ...
      <div>
        ${this.opp!.localize("ui.dialogs.zha_device_info.last_seen")}:
        ${this._zhaDevice.last_seen ||
        this.opp!.localize("ui.dialogs.zha_device_info.unknown")}
      </div>
      <div>
        ${this.opp!.localize("ui.dialogs.zha_device_info.power_source")}:
