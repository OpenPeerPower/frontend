        ...
        <form>
          <paper-input
            .label=${this._subscribed
              ? this.opp.localize("ui.panel.config.mqtt.listening_to")
              : this.opp.localize("ui.panel.config.mqtt.subscribe_to")}
          ...
          >
            ${this._subscribed
              ? this.opp.localize("ui.panel.config.mqtt.stop_listening")
              : this.opp.localize("ui.panel.config.mqtt.start_listening")}
          </mwc-button>
        </form>
        <div class="events">
          ${this._messages.map(
            (msg) => html`
              <div class="event">
                ${this.opp.localize(
                  ...
                  msg.message.topic,
                  "time",
                  formatTime(msg.time, this.opp!.locale)
                )}
                <pre>${msg.payload}</pre>
                <div class="bottom">
