...
export class DialogLovelaceDashboardDetail extends LitElement {
  ...
  protected render(): TemplateResult {
    ...
    const defaultPanelUrlPath = this.opp.defaultPanel;
    const urlInvalid =
            ...
            : html`
                ...
                <div class="form">
                  <paper-input
                    ...
                    @blur=${this.opp.userData?.showAdvanced
                      ? this._fillUrlPath
                      : undefined}
  ...
  private _fillUrlPath() {
    if ((this.opp.userData?.showAdvanced && this._urlPath) || !this._title) {
      return;
    }
  ...
  private _toggleDefault() {
    ...
    setDefaultPanel(
      this,
      urlPath === this.opp.defaultPanel ? DEFAULT_PANEL : urlPath
    );
  }
