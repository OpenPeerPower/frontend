  ...
  implements OppDialog<TagDetailDialogParams>
{
      ...
      <op-dialog
        ...
        .heading=${createCloseHeading(
          ...
          this._params.entry
            ...
            : this.opp!.localize("ui.panel.config.tag.detail.new_tag")
        )}
      >
        <div>
          ...
          <div class="form">
            ...
            <paper-input
              ...
              .label="${this.opp!.localize("ui.panel.config.tag.detail.name")}"
        ...
        ${this._params.entry
          ? html`
              ...
              >
                ${this.opp!.localize("ui.panel.config.tag.detail.delete")}
              </mwc-button>
            `
          : html``}
        <mwc-button
        ...
        >
          ${this._params.entry
            ? this.opp!.localize("ui.panel.config.tag.detail.update")
            : this.opp!.localize("ui.panel.config.tag.detail.create")}
        </mwc-button>
  ...
  private async _generateQR() {
    ...
    const canvas = await qrcode.toCanvas(
      `https://www.openpeerpower.io/tag/${this._params!.entry!.id}`,
      {
        width: 180,
