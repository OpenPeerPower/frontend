  ...
  protected render(): TemplateResult {
    ...
    return html`
      <op-dialog
        ...
        scrimClickAction
        escapeKeyAction
        .heading=${createCloseHeading(this.opp, user.name)}
      >
        <div>
          ${this._error ? html` <div class="error">${this._error}</div> ` : ""}
          <div class="secondary">
            ${this.opp.localize("ui.panel.config.users.editor.id")}:
            ${user.id}<br />
            ${this.opp.localize("ui.panel.config.users.editor.username")}:
            ${user.username}
          </div>
          <div>
            ${user.is_owner
        ...
        <div slot="secondaryAction">
          <mwc-button
            ...
            user.is_owner}
          >
            ${this.opp!.localize("ui.panel.config.users.editor.delete_user")}
          </mwc-button>
          ${user.system_generated
            ? html`
              ...
              `
            : ""}
          ${!user.system_generated && this.opp.user?.is_owner
        ...
        <div slot="primaryAction">
          <mwc-button
            ...
            user.system_generated}
          >
            ${this.opp!.localize("ui.panel.config.users.editor.update_user")}
          </mwc-button>
          ${user.system_generated
            ? html`
