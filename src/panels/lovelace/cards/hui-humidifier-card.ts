...
export class HuiHumidifierCard extends LitElement implements LovelaceCard {
  ...
  protected render(): TemplateResult {
    ...
    const stateObj = this.opp.states[this._config.entity] as HumidifierEntity;
    ...
    const rtlDirection = computeRTLDirection(this.opp);
  ...
  protected updated(changedProps: PropertyValues): void {
    ...
    if (
      !this._config ||
      !this.opp ||
      (!changedProps.has("opp") && !changedProps.has("_config"))
    ) {
      return;
    }
    ...
    if (!oldOpp || oldOpp.states[this._config.entity] !== stateObj) {
  ...
  private _getSetHum(stateObj: OppEntity): undefined | number {
  ...
  private _setHumidity(e): void {
    this.opp!.callService("humidifier", "set_humidity", {
