          ...
          <text text-anchor="middle" class="set-value">
            ${
              stateObj.state === UNAVAILABLE
                ...
                ? this._stepSize === 1
                  ? svg`
                      ${formatNumber(this._setTemp[0], this.opp.locale, {
                        maximumFractionDigits: 0,
                      })} -
                      ${formatNumber(this._setTemp[1], this.opp.locale, {
                        maximumFractionDigits: 0,
                      })}
                      `
                  : svg`
                ...
                : this._stepSize === 1
                ? svg`
                      ${formatNumber(this._setTemp, this.opp.locale, {
                        maximumFractionDigits: 0,
                      })}
                      `
                : svg`
