  ...
  implements LovelaceCardEditor
{
                  ...
                  <div class="condition">
                    ...
                    <div class="state">
                      ...
                      <paper-input
                        ...
                        )}: '${this.opp?.states[cond.entity].state}')"
  ...
  private _handleGUIModeChanged(ev: OPPDomEvent<GUIModeChangedEvent>): void {
    ev.stopPropagation();
  ...
  private _handleCardChanged(ev: OPPDomEvent<ConfigChangedEvent>): void {
    ev.stopPropagation();
    if (!this._config) {
      return;
    }
