...
class HaMfaModuleSetupFlow extends LitElement {
  ...
  protected firstUpdated(changedProperties) {
    ...
    this.opp.loadBackendTranslation("mfa_setup", "auth");
  ...
  private _computeStepTitle() {
    return this._step?.type === "abort"
      ? this.opp.localize("ui.panel.profile.mfa_setup.title_aborted")
      : this._step?.type === "create_entry"
      ? this.opp.localize("ui.panel.profile.mfa_setup.title_success")
      : this._step?.type === "form"
      ? this.opp.localize(
